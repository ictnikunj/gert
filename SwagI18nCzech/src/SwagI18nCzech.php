...
use SwagI18nCzech\Resources\app\core\snippet\SnippetFile_cs_CZ as SnippetFile;

class SwagI18nCzech extends Plugin
{
    public const SWAG_I18N_LOCALE_CODE = 'cs-CZ';
    public const SWAG_I18N_LANGUAGE_NAME = 'Čeština';
