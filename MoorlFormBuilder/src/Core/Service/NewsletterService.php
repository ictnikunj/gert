...
class NewsletterService
{
    ...
    public function subscribe(array $rawData, SalesChannelContext $context, bool $validateStorefrontUrl = true): NoContentResponse
    {
        $rawData['option'] = 'subscribe';

        $validator = $this->getOptInValidator($context, $validateStorefrontUrl);
        $this->validator->validate($rawData, $validator);
    ...
    private function completeData(array $data, SalesChannelContext $context): array
    {
        ...
        //$data['storefrontUrl'] = $context->getSalesChannel()->getDomains()->first()->getUrl();
