...
use SwagI18nPolish\Resources\app\core\snippet\SnippetFile_pl_PL as SnippetFile;

class SwagI18nPolish extends Plugin
{
    public const SWAG_I18N_LOCALE_CODE = 'pl-PL';
    public const SWAG_I18N_LANGUAGE_NAME = 'Polski';
