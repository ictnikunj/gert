...
use SwagI18nFrench\Resources\app\core\snippet\SnippetFile_fr_FR as SnippetFile;

class SwagI18nFrench extends Plugin
{
    public const SWAG_I18N_LOCALE_CODE = 'fr-FR';
    public const SWAG_I18N_LANGUAGE_NAME = 'Français';
