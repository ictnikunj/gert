 ...
 */
class ProductCrossAddonImportController extends AbstractController
{
    /**
    ...
    /**
     * @Route("/api/pim/productcrosssellingaddon", name="api.action.pim.product.crossaddon.import", methods={"GET"})
     */
    public function productCrossImport($val = null,Context $context): JsonResponse
    {
        ...
        $addonProductCounter = $this->systemConfigService->get('PimImport.config.addonProductCounter');
        ...
        if ($err) {
            ...
            $this->systemConfigService->set('PimImport.config.addonProductCounter',$counter);
