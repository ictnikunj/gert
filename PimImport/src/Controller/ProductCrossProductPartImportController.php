 ...
 */
class ProductCrossProductPartImportController extends AbstractController
{
    /**
    ...
    /**
     * @Route("/api/pim/productcrosssellingproductpart", name="api.action.pim.product.crossproductpart.import", methods={"GET"})
     */
    public function productCrossImport($val = null,Context $context): JsonResponse
    {
        ...
        $productPartCounter = $this->systemConfigService->get('PimImport.config.productPartCounter');
        ...
        if ($err) {
                                ...
                                if ($res->SubProducts) {
                                    ...
                                    foreach ($res->SubProducts as $subproduct) {
                                        ...
                                        if (!empty($this->checkProductNumber($productPartNumber))) {
                                            ...
                                            if ($productPartID) {
                                                $i++;
                                                //insert in cross sell product part product
                                                $data = [
            ...
            $this->systemConfigService->set('PimImport.config.productPartCounter',$counter);
