...
use SwagI18nSpanish\Resources\app\core\snippet\SnippetFile_es_ES as SnippetFile;

class SwagI18nSpanish extends Plugin
{
    public const SWAG_I18N_LOCALE_CODE = 'es-ES';
    public const SWAG_I18N_LANGUAGE_NAME = 'Español';
